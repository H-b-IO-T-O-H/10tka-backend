...
(
    ...
    prof_disciplines varchar(128)[] default array []:: varchar(128)[],
    student_group    varchar(8),
    social_network   text,
    about            text
);
...
(
    discipline_id serial4
        constraint discipline_id_pkey primary key,
    discipline    varchar(128) not null unique,
    prof_cnt      int2
);
